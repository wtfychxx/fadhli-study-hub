...
@section('content')
    <link href="{{ url('templates/extra-libs/c3/c3.min.css') }}" rel="stylesheet">
    <link href="{{ url('templates/libs/chartist/dist/chartist.min.css') }}" rel="stylesheet">
    <link href="{{ url('templates/extra-libs/jvector/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet" />
                        ...
                        <table class="table no-wrap v-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="border-top-0 px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img src="{{ url('templates/images/users/widget-table-pic1.jpg') }}"
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img src="{{ url('templates/images/users/widget-table-pic2.jpg') }}"
                                                    alt="user" class="rounded-circle" width="45"
                                                    height="45" /></div>
                                            <div class="">
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img src="{{ url('templates/images/users/widget-table-pic3.jpg') }}"
                                                    alt="user" class="rounded-circle" width="45"
                                                    height="45" /></div>
                                            <div class="">
                                ...
                                <tr>
                                    <td class="px-2 py-4">
                                        <div class="d-flex no-block align-items-center">
                                            <div class="mr-3"><img src="{{ url('templates/images/users/widget-table-pic4.jpg') }}"
                                                    alt="user" class="rounded-circle" width="45"
                                                    height="45" /></div>
                                            <div class="">
    ...
    @section('jsLibrary')
    <script src="{{ url('templates/extra-libs/c3/d3.min.js') }}"></script>
    <script src="{{ url('templates/extra-libs/c3/c3.min.js') }}"></script>
    <script src="{{ url('templates/libs/chartist/dist/chartist.min.js') }}"></script>
    <script src="{{ url('templates/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js') }}"></script>
    <script src="{{ url('templates/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js') }}"></script>
    <script src="{{ url('templates/extra-libs/jvector/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script src="{{ url('templates/js/pages/dashboards/dashboard1.min.js') }}"></script>
    @endsection
@endsection
